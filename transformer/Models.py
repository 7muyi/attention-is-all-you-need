...
class PositionEncoding(nn.Module):
    ...
    def _get_sinusoid_encoding_table(self, n_position, d_hid):
        ...
        sinusoid_table = np.array([get_position_angle_vec(pos_i) for pos_i in range(d_hid)])
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        if emb_src_trg_weight_sharing:
            self.encoder.src_word_emb.wight = self.decoder.trg_word_emb
